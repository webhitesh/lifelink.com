...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Check in database
    $sql = "SELECT * FROM requesters WHERE email='$email' AND pass='$password'";
...
<section class="login-section">
  <div class="container">
    ...
    <p>Please enter your details to log in and track your requests.</p>

    <form action="rlogin.php" method="post" class="login-form">
    ...
    <p class="note">Not registered yet? <a href="requester.php">Register as Recipient</a></p>
  </div>
</section>
